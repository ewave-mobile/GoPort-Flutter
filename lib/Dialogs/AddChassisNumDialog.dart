...
class _AddChassisNumDialogState extends State<AddChassisNumDialog> {
  TextEditingController _shildaController = new TextEditingController();
  ...
  _loadNotChosenChassis() {
    ...
    for (Chassis chassis in widget.availableChassis) {
      ...
      bool isChosen = false;
      for (Chassis fill in widget.chosenChassis) {
        if (fill.chassisID == chassis.chassisID) {
          isChosen = true;
          continue;
        }
      }
          ...
          children: [
            Row(
              ...
              children: [
                  ...
                  child: Autocomplete<Chassis>(
                        ...
                        return TextField(
                          decoration: InputDecoration(
                            labelText: AppLocalizations.of(context)
                                .translate(
                                "Shilda number"),
                            hintText: AppLocalizations.of(context).translate("Enter Shilda number"),
                          ),
                      ...
                      optionsBuilder: (TextEditingValue textEditingValue) {
                        ...
                        return _chassisNotChosen.where((Chassis option) {
                          return option.chassisID.toLowerCase()
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    Text(
                                                      option.chassisID,
                                                      style: TextStyle(color: colorLogo2, fontSize: 15, fontWeight: FontWeight.bold),
                                                    )
                                                  ],
                                                ),
                                                SizedBox(
                ...
                Image.asset(_chosenChassis != null ? "assets/images/ic_verification_checkmark_symbol.png" : "assets/images/ic_pencil_edit_button.png", width: 20, height: 20,)
              ],
            ),
            SizedBox(
              height: 20,
            ),
            _chassisNotChosen != null && _chosenChassis != null ? Column(
              children: [
                Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Text(
                      AppLocalizations.of(context).translate("Manufacturer") + ":",
                      style: TextStyle(color: colorLightGray, fontSize: 16),
                    ),
                    SizedBox(
                      width: 6,
                    ),
